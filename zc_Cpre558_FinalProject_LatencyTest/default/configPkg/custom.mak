...
linker.cmd: package/cfg/app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/app_pem4fcfg.cmd\)\"$""\"J:/.docs/academics/iowa_state/cpre558/project/git/zc_Cpre558_FinalProject_LatencyTest/default/configPkg/\1\""' package/cfg/app_pem4f.xdl > $@
